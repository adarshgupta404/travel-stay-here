...
const PropertyPageDetails = ({ property }: { property: IProperty }) => {
  ...
  const handleBooking = async () => {
    ...
    startTransition(async () => {
      if (!property._id || !user._id || !dateRange?.from || !dateRange?.to)
        return;
                ...
                <div className="p-3 px-4 bg-green-100 flex items-center gap-3 rounded-lg border border-green-300 text-green-800">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      ...
                      {available.availableRooms === 1 ? "room" : "rooms"}{" "}
                      available
                    </p>
                  </div>
                </div>
                    ...
                    <div className="bg-muted rounded-lg h-[200px] flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Coordinates: {property.coordinates?.latitude},{" "}
                      ...
                      <div>
                        ...
                        {property.policies?.cancellation === "Moderate" && (
                          <p className="text-sm text-muted-foreground mt-1">
                            Full refund if cancelled 5 days before check-in, 50%
                            refund until 24 hours before check-in.
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-4 p-4 border rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="mt-3 text-sm text-muted-foreground">
                        Professional host managing this{" "}
                        {property.type.toLowerCase()} with excellent service and
                        attention to detail.
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                <div className="bg-muted/50 p-4 rounded-lg space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span>
                      Rs.{property.price.toFixed(2)} × {rooms}{" "}
                      {rooms > 1 ? "rooms" : "room"}
                    </span>
                  ...
                  {property.discount > 0 && totalNights > 0 && (
                    <div className="flex justify-between text-green-600">
                      ...
                      <span>
                        -Rs.{(totalPrice - discountedPrice).toFixed(2)}
                      </span>
                    </div>
                  )}
                  <Separator />
